...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        Integer[] friendIDs = ((List<Integer>) getArguments().get(MainActivity.TAG_FRIEND_RES_IDS)).toArray(new Integer[((List<Integer>) getArguments().get(MainActivity.TAG_FRIEND_RES_IDS)).size()]);
	...
	public class DownloaderTask extends AsyncTask<Integer, Void, String[]> {
        ...
        protected void onPostExecute(String[] result) {
            if(isAdded()) mCallback.notifyDataRefreshed(result);
        }
    }
}