...
public class DownloaderTaskFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        List<Integer> friendsIds = getArguments().getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);

        // Start the DownloaderTask
        downloaderTask.execute(friendsIds.toArray(new Integer[friendsIds.size()]));
