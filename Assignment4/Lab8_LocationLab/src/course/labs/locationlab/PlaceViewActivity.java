...
public class PlaceViewActivity extends ListActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View footerView = myInflater.inflate(R.layout.footer_view, null);
    ...
    public void addNewPlace(PlaceRecord place) {
        ...
        if (place == null) {
            Toast.makeText(this, getString(R.string.placebadge_could_not_be_acquired), Toast.LENGTH_LONG).show();
        } else if (place.getCountryName() == null) {
            Toast.makeText(this, getString(R.string.no_country_string), Toast.LENGTH_LONG).show();
        } else {
            mAdapter.add(place);
        }
    }
    ...
    public void onLocationChanged(Location currentLocation) {
        ...
        if (null == mLastLocationReading || (ageInMilliseconds(currentLocation) > ageInMilliseconds(mLastLocationReading))) {
